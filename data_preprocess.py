...
def settings():
    ...
    parser.add_argument('--path', default='./data/', type=str,
                       help='data path')
    parser.add_argument('--data_name', default='NYC', type=str,
                       help='data name')
...
def preprocessing(params):
    ...
    filepath = f'{params.path}{params.data_name}.{params.filetype}'
    ...
    # store
    filter_path = f'{params.path}{params.data_name}_filtered.txt'
    ...
    # Merge data 
    print('='*20, 'Merging')
    merge_path = f'{params.path}{params.data_name}_merged.txt'
